...
public class ToStringBuilder {
    ...
    public ToStringBuilder date(String name, Date value) {
        if(value != null) {
            try {
                return addText(name, CommonConstant.DATE_FORMAT.format(value));
            } catch (Exception ex) {
                // ignore
            }
        }
    ...
    public ToStringBuilder dateTime(String name, Date value) {
        if(value != null) {
            try {
                return addText(name, CommonConstant.DATE_TIME_FORMAT.format(value));
            } catch (Exception ex) {
                // ignore
            }
        }
    ...
    public ToStringBuilder localDate(String name, LocalDate value) {
        if(value != null) {
            try {
                return addText(name, value.format(CommonConstant.DATE_FORMATTER));
            } catch (Exception ex) {
                // ignore
            }
        }
    ...
    public ToStringBuilder localDateTime(String name, LocalDateTime value) {
        if(value != null) {
            try {
                return addText(name, value.format(CommonConstant.DATE_TIME_FORMATTER));
            } catch (Exception ex) {
                // ignore
            }
        }
